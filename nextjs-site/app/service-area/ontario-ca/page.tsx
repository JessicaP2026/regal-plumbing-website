  ...
  return (
    <CityPageTemplate
      ...
      introText={[
        ...
        <>Regal Plumbing &amp; Rooter is based right here in Ontario at 2141 E Philadelphia St, Suite R &mdash; which means we respond faster than anyone else when emergencies strike. Whether you&apos;re dealing with a{' '}<Link href="/slab-leak-detection" className="text-red font-medium hover:underline">slab leak</Link>{' '}in Ontario Ranch, a{' '}<Link href="/drain-cleaning" className="text-red font-medium hover:underline">clogged main sewer</Link>{' '}near Gramercy, or a{' '}<Link href="/water-heater-services" className="text-red font-medium hover:underline">failed water heater</Link>{' '}near the airport corridor, our licensed technicians are on the road within the hour.</>,
      ]}
      serviceDescriptions={[
